...
def print_family_tree(person, level=0):
    ...
    father_, mother_ = person.get_parents()
    if father_:
        print_family_tree(father_, level + 1)
    if mother_:
        print_family_tree(mother_, level + 1)
...
if __name__ == '__main__':
    ...
    father1 = Person("батько", father=grandfather1, mother=grandmother1)
    mother1 = Person("мати", father=grandfather2, mother=grandmother2)
    son = Person("син", father=father1, mother=mother1)
